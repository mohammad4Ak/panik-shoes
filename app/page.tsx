        ...
        <div className={`flex flex-col h-full p-3 bg-white dark:bg-gray-800 shadow transition-all duration-300 ${
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    {isSidePanelOpen && <h2 className="text-xl font-bold mr-7">پانیک</h2>}
                    {!isMobile && (
                        <Button
                ...
                <div className="flex-1">
                    <ul className="pt-2 pb-4 space-y-1 text-sm">
                        <li>
                            ...
                            >
                                {isSidePanelOpen ? 'محصولات' : <PackageSearch className="h-5 w-5"/>}
                            </NavLink>
                        </li>
                        <li>
                            <NavLink
                        ...
                        <li>
                            ...
                            >
                                {isSidePanelOpen ? 'موجودی' : <Footprints className="h-5 w-5"/>}
                            </NavLink>
                        </li>
                        <li>
                            <NavLink
                            ...
                            >
                                {isSidePanelOpen ? 'فروش' : <ChartNoAxesCombined className="h-5 w-5"/>}
                            </NavLink>
                        </li>
                    </ul>
                </div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <header className="flex items-center justify-between p-4 bg-white dark:bg-gray-800 shadow">
                    <div className="flex items-center">
                        {isMobile && (
                            <Button variant="ghost" size="icon" onClick={() => setIsSidePanelOpen(true)}
                                    className="mr-2">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 dark:bg-gray-900">
                    <div
                        className="p-2 sm:p-4 md:p-8 lg:p-12 xl:p-16 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl">
                        {renderPage()}
                    </div>
                </main>
            </div>
